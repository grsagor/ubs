@if (!empty($__subscription) && env('APP_ENV') != 'demo')
    <i class="fas fa-info-circle pull-left mt-10 cursor-pointer mobile_info_icon" style= "margin-top: 24px; color:white"
        aria-hidden="true" data-toggle="popover" data-html="true" title="@lang('superadmin::lang.active_package_description')" data-placement="right"
        data-trigger="hover"
        data-content="
