<div class="modal fade reminder" id="exampleModalCenter" tabindex="-1" role="dialog"
    aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        {!! Form::open([
            'url' => action([\Modules\Essentials\Http\Controllers\ReminderController::class, 'store']),
            'id' => 'reminder_form',
        ]) !!}
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="action_url" value="/essentials/reminder">
