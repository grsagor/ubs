            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    @if($__is_admin)
                        ...
                        <li @if(request()->get('type') == 'project') class="active" @endif><a href="{{action('\App\Http\Controllers\TaxonomyController@index') . '?type=project'}}">@lang('project::lang.project_categories')</a></li>
                    @endif
                </ul>
