                    ...
                    foreach ($sorted_projects as $key => $projects) {
                        ...
                        foreach ($projects as $project) {
                            ...
                            if (auth()->user()->can('project.edit_project')) {
                                $edit = action('\Modules\Project\Http\Controllers\ProjectController@edit', ['project' => $project->id]);
                            }

                            $delete = '';
                            if (auth()->user()->can('project.delete_project')) {
                                $delete = action('\Modules\Project\Http\Controllers\ProjectController@destroy', ['project' => $project->id]);
                            }
