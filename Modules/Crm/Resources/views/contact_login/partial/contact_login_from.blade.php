...
<div class="row @if ($index !== 0) hide @endif" id="add_contact_person_div_{{ $index }}">
    <div class="col-md-2">
        <div class="form-group">
            ...
            {!! Form::text($index === '' ? 'surname' : "contact_persons[$index][surname]", null, [
                'class' => 'form-control',
    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            {!! Form::text($index === '' ? 'first_name' : "contact_persons[$index][first_name]", null, [
                'class' => 'form-control',
                'required',
    ...
    <div class="col-md-5">
        <div class="form-group">
            ...
            {!! Form::text($index === '' ? 'last_name' : "contact_persons[$index][last_name]", null, [
                'class' => 'form-control',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text($index === '' ? 'email' : "contact_persons[$index][email]", null, [
                'class' => 'form-control',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text(
                $index === '' ? 'contact_number' : "contact_persons[$index][contact_number]",
                !empty($user->contact_number) ? $user->contact_number : null,
                ['class' => 'form-control', 'placeholder' => __('lang_v1.mobile_number'), 'id' => "contact_number$index"],
            ) !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text(
                $index === '' ? 'alt_number' : "contact_persons[$index][alt_number]",
                !empty($user->alt_number) ? $user->alt_number : null,
                ['class' => 'form-control', 'placeholder' => __('business.alternate_number'), 'id' => "alt_number$index"],
            ) !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text(
                $index === '' ? 'family_number' : "contact_persons[$index][family_number]",
                !empty($user->family_number) ? $user->family_number : null,
                ['class' => 'form-control', 'placeholder' => __('lang_v1.family_contact_number'), 'id' => "family_number$index"],
            ) !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text(
                $index === '' ? 'crm_department' : "contact_persons[$index][crm_department]",
                !empty($user->crm_department) ? $user->crm_department : null,
                ['class' => 'form-control', 'placeholder' => __('lang_v1.department'), 'id' => "department$index"],
            ) !!}
        </div>
    </div>
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text(
                $index === '' ? 'crm_designation' : "contact_persons[$index][crm_designation]",
                !empty($user->crm_designation) ? $user->crm_designation : null,
                ['class' => 'form-control', 'placeholder' => __('lang_v1.designation'), 'id' => "designation$index"],
            ) !!}
        </div>
    </div>
    <div class="clearfix"></div>
...
<div class="row hide" id="loginDiv{{ $index }}">
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::text($index === '' ? 'username' : "contact_persons[$index][username]", null, [
                'class' => 'form-control',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::password($index === '' ? 'password' : "contact_persons[$index][password]", [
                'class' => 'form-control',
                'required',
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            {!! Form::password($index === '' ? 'confirm_password' : "contact_persons[$index][confirm_password]", [
                'class' => 'form-control',
                'required',
                'placeholder' => __('business.confirm_password'),
                'id' => "confirm_password$index",
                'data-rule-equalTo' => "#password$index",
            ]) !!}
        </div>
    </div>
    <div class="clearfix"></div>
