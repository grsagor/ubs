...
@if ($child_category == 11)
    ...
    <div class="col-sm-12">
        <div class="form-group">
            <label for="selling_price_group_id">Pets?</label> <i class="fa fa-info-circle text-info hover-q no-print "
                aria-hidden="true" data-container="body" data-toggle="popover" data-placement="auto bottom"
                data-content="This price group will be used as the default price group in this location."
                data-html="true" data-trigger="hover"></i> <select class="form-control" id="pets" name="pets">
                <option value="2">no</option>
                <option value="1">yes</option>
                <option value="I don't mind">I don't mind</option>
            </select>
