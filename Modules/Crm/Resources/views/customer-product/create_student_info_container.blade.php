<div class="col-sm-12">
    <div class="form-group">
        ...
        <input class="form-control" name="occupant_university_name[]" type="text"
            ...
            <span class="error text-danger" id="occupant_university_name-error"></span>
    </div>
</div>
<div class="col-sm-12">
    <div class="form-group">
        ...
        <input class="form-control" name="occupant_degree_name[]" type="text"
            ...
            <span class="error text-danger" id="occupant_degree_name-error"></span>
    </div>
</div>
<div class="col-sm-12">
    <div class="form-group">
        ...
        <span class="error text-danger" id="occupant_job-error--property_wanted_create"></span>
    </div>
</div>