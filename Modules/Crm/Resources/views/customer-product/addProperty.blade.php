                                ...
                                <div class="edit-info-area">
                                    <div class="body">
                                        <div class="edit-info-area-form">
                                            ...
                                            <form action="{{ route('user.save.property.wanted') }}"
                                                id="property_wanted_form" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                <div id="showingbtn1">
                                                    ...
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-lg-7 d-flex gap-3">
                                                            <div class="d-flex gap-1">
                                                                <input type="radio" name="room_size" id="asingleordouble">
                                                                <label for="asingleordouble">A single or double room</label>
                                                            </div>
                                                            <div class="d-flex gap-1">
                                                                <input type="radio" name="room_size" id="dobuleroom">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <div class="d-flex gap-1">
                                                                <input type="checkbox" name="buddy_ups" id="buddy_ups">
                                                                <span><label for="buddy_ups">A single or double
                                                                        room</label></span>
                                                            </div>
                                                            <div>
                                                                Tick this if you might like to Buddy Up with other room
                                                                seekers to find a whole flat or house together and start a
                                                                brand new flat/house share.
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="showingbtn2" class="d-none">
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <div class="left-area">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <select name="reason_to_leave">
                                                                <option value="" selected="">Select an area...
                                                                </option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7 d-flex">
                                                            ...
                                                            <select name="per">
                                                                <option value="" selected="">Per week or month
                                                                </option>
                                                        ...
                                                        <div class="col-lg-7 d-flex">
                                                            <div>
                                                                ...
                                                                <label for="living_room"><input type="checkbox"
                                                                        name="roomfurnishings[]" value="living_room"
                                                                        id="living_room">Shared living room</label>
                                                                <label for="washing_machine"><input type="checkbox"
                                                                        name="roomfurnishings[]" value="washing_machine"
                                                                        id="washing_machine">Washing machine</label>
                                                            ...
                                                            <div>
                                                                <label for="off_street_parking"><input type="checkbox"
                                                                ...
                                                                <label for="disabled_access"><input type="checkbox"
                                                                        name="roomfurnishings[]" value="disabled_access"
                                                                        id="disabled_access">Disabled access</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7 d-flex">
                                                            <select name="share_type">
                                                                <option value="ND" selected="">Not disclosed
                                                                </option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                            ...
                                                            <label class="form_input form_checkbox">
                                                                ...
                                                                Yes, I would like my orientation to form part of my ad's
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <select name="nationality">
                                                                ...
                                                                <option value="Antigua and Barbuda">Citizen of Antigua and
                                                                    Barbuda</option>
                                                                ...
                                                                <option value="Bosnia and Herzegovina">Citizen of Bosnia
                                                                    and Herzegovina</option>
                                                                <option value="Botswanan">Botswanan</option>
                                                                <option value="Brazilian">Brazilian</option>
                                                                <option value="British">British</option>
                                                                <option value="British Virgin Islander">British Virgin
                                                                    Islander</option>
                                                                ...
                                                                <option value="Guinea-Bissau">Citizen of Guinea-Bissau
                                                                </option>
                                                                ...
                                                                <option value="Liechtenstein citizen">Liechtenstein citizen
                                                                </option>
                                                                ...
                                                                <option value="Turks and Caicos Islander">Turks and Caicos
                                                                    Islander</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                            <select name="gay_lesbian_req">
                                                                <option value="ND" selected="">Not important
                                                                </option>
                                                                <option value="S">Straight</option>
                                                                <option value="G">Gay/Lesbian</option>
                                                                <option value="B">Bisexual</option>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#next1").click(function() {
                $("#showingbtn1").addClass("d-none");
                $("#showingbtn2").removeClass("d-none");
                $("#nextprev1").addClass("d-none").removeClass("d-flex gap-1 justify-content-between");
                $("#nextprev2").removeClass("d-none").addClass("d-flex gap-1 justify-content-between");
            });

            $("#prev2").click(function() {
                $("#showingbtn1").removeClass("d-none");
                $("#showingbtn2").addClass("d-none");
                $("#nextprev1").removeClass("d-none").addClass("d-flex gap-1 justify-content-between");
                $("#nextprev2").addClass("d-none").removeClass("d-flex gap-1 justify-content-between");
            });
        });
    </script>
    <script>
