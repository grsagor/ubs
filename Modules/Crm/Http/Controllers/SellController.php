...
{
    public function getListCustomerSells($id, $sale_type = 'sell')
    {
    ...
    {
        $user = Auth::user();
        $sells = $this->getListCustomerSells($user->id, '');
        ...
        if (request()->ajax()) {
            ...
            $sells = $this->getListCustomerSells($user->id, $sale_type);
            ...
            $datatable            = Datatables::of($sells)
                ...
                ->addColumn('return_due', function ($row) {
                    ...
                    //     $return_due_html .= '<a href="' . action([\App\Http\Controllers\TransactionPaymentController::class, 'show'], [$row->return_transaction_id]) . '" class="view_purchase_return_payment_modal"><span class="sell_return_due" data-orig-value="' . $row->total_paid . '">' . $this->transactionUtil->num_f($row->total_paid, true) . '</span></a>';
                    // }
                ...
                ->addColumn('conatct_name', 'Hello')
                ->editColumn('total_items', 'Hello')
                ...
                ->editColumn('so_qty_remaining', 'hello')
                ->setRowAttr([
            ...
            $rawColumns = ['final_total', 'action', 'total_paid', 'total_remaining', 'payment_status', 'invoice_no', 'discount_amount', 'tax_amount', 'total_before_tax', 'shipping_status', 'types_of_service_name', 'payment_methods', 'return_due', 'conatct_name', 'status', 'customer_name'];
        ...
        return view('crm::sell.index')
            ->with(compact('is_cmsn_agent_enabled', 'commission_agents'));
    }
