...
@section('content')
    ...
    <section class="content">
        <div class="form-container box box-primary">
            ...
            <div class="box-body">
                <form action="{{ route('shop_news_category_update', $sub_category->id) }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="category_type" required id="type">
                            ...
                            <option value="news"
                                {{ old('category_type', $sub_category->category_type) == 'news' ? 'selected' : '' }}>
                                News
                            </option>
                            <option value="marketing"
                                {{ old('category_type', $sub_category->category_type) == 'marketing' ? 'selected' : '' }}>
                                Marketing
                            </option>
                        </select>
                    </div>
