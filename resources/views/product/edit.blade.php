    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::select('class', ['Product'=>'Product','Service'=>'Service','Product & Service'=>'Both'], !empty($product->class) ? $product->class : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'required']); !!}
                </div>
            </div>
        ...
        @component('components.widget', ['class' => 'box-primary'])
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            {!! Form::label('study_time', __('product.study_time') . ':') !!}
                            {!! Form::select('study_time', ['Part Time','Full Time'], !empty($product->study_time) ? $product->study_time : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'required']); !!}
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-6" id="every-year-div">
                                    <div class="form-group">
                                        <label>
                                            {!! Form::checkbox('every_year', 1, !(empty($product)) ? $product->every_year : false, ['class' => 'input-icheck', 'id'=>'every_year']); !!} <strong>Every Year</strong>
                                        </label>
                                    </div>
                                </div>
                                <div class="col-sm-6" id="select-year-div">
                                    <div class="form-group">
                                        <label>
                                            {!! Form::checkbox('select_year', 1, !(empty($product)) ? $product->select_year : false, ['class' => 'input-icheck', 'id'=>'select_year']); !!} <strong>Select Year</strong>
                                        </label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    {!! Form::select('duration_year', ['1','2','3','4','5'], !empty($product->duration_year) ? $product->duration_year : null, ['class' => 'form-control select2', 'required', 'placeholder' => 'Year']); !!}
                                </div>
                                <div class="col-md-6">
                                    {!! Form::select('duration_month', ['1','2','3','4','5','7','8','9','10','11'], !empty($product->duration_month) ? $product->duration_month : null, ['class' => 'form-control select2', 'required', 'placeholder' => 'Month']); !!}
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::select('work_placement', ['Available'=>'Available','Unavailable'=>'Unavailable'], !empty($product->work_placement) ? $product->work_placement : null, ['placeholder' => __('messages.please_select'), 'id'=>'work_placement', 'class' => 'form-control select2', 'required']); !!}
                </div>
            </div>
            <div class="col-sm-8 hide" id="work-placement-description-section">
                <div class="form-group">
                    ...
                    {!! Form::textarea('work_placement_description', !empty(@$product->work_placement_description) ? @$product->work_placement_description : null, ['class' => 'form-control']); !!}
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::select('tuition_fee_installment', ['Available'=>'Available','Unavailable'=>'Unavailable'], !empty($product->tuition_fee_installment) ? $product->tuition_fee_installment : null, ['placeholder' => __('messages.please_select'), 'id'=>'fee_installment', 'class' => 'form-control select2', 'required']); !!}
                </div>
            </div>
            ...
            <div class="col-sm-8 hide" id="fee-installment-description-section">
                <div class="form-group">
                    ...
                    {!! Form::textarea('fee_installment_description', !empty(@$product->fee_installment_description) ? @$product->fee_installment_description : null, ['class' => 'form-control']); !!}
                </div>
            </div>
            ...
            <div class="row requirements-section">
                ...
                <div class="col-sm-8">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('requirement_details', !empty($product->requirement_details) ? $product->requirement_details : null, ['class' => 'form-control requirement_details', 'id'=>'requirement_details']); !!}
                    </div>
                </div>
            </div>
        </div>
    ...
    @component('components.widget', ['class' => 'box-primary'])
        <div class="row">
            ...
            <div class="form-group col-sm-12" >
                @include('product.partials.edit_single_product_form_part_2', ['profit_percent' => $default_profit_percent])
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-4" id="resellingCommissionAmountFixedSection">
                <div class="form-group">
                    ...
                    {!! Form::text('reselling_commission_amount', !empty($product->reselling_commission_amount) ? $product->reselling_commission_amount : null, ['class' => 'form-control', 'required', 'placeholder' => __('product.reselling_commission_amount'), 'id' => 'resellingCommissionAmountFixed']); !!}
                </div>
            </div>
            ...
            <div class="col-sm-4 hide" id="resellingCommissionAmountPercentageSection">
                <div class="form-group">
                    ...
                    {!! Form::select('reselling_commission_amount', range(0, 100), !empty($product->reselling_commission_amount) ? $product->reselling_commission_amount : null, ['class' => 'form-control', 'required', 'placeholder' => __('product.reselling_commission_amount'), 'id' => 'resellingCommissionAmountPercentage']); !!}
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    {!! Form::number('extra_commission', !empty($product->extra_commission) ? $product->extra_commission : null, ['class' => 'form-control', 'required',
