                ...
                <div class="col-sm-4 @if (!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            ...
                            ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id' => 'sub_category_id'],
                        ) !!}
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea(
                            ...
                            ['class' => 'form-control', 'required', 'id' => 'define_this_item'],
                        ) !!}
                        <div id="char_count"></div>
                        <div id="error_message_define_this_item" style="color: red; display: none;">characters limit exceeded!
