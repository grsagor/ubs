            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('class', ['Product'=>'Product','Service'=>'Service','product_service'=>'Both'], !empty($duplicate_product->class) ? $duplicate_product->class : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'id'=>'product_class', 'required']); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                ...
                <div class="col-sm-4 @if(!session('business.enable_category')) hide @endif">
                    <div class="form-group">
                        ...
                        {!! Form::select('category_id', $categories, !empty($duplicate_product->category_id) ? $duplicate_product->category_id : null, ['placeholder' => __('messages.please_select'), 'id'=>'category_id', 'class' => 'form-control select2']); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="col-sm-4 @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
                    <div class="form-group">
                        ...
                        {!! Form::select('child_category_id', $child_categories, !empty($duplicate_product->child_category_id) ? $duplicate_product->child_category_id : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2']); !!}
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('study_time', ['Part Time','Full Time'], !empty($duplicate_product->name) ? $duplicate_product->name : null, ['placeholder' => __('messages.please_select'),'class' => 'form-control select2', 'required']); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-sm-6" id="every-year-div">
                                <div class="form-group">
                                    <label>
                                        {!! Form::checkbox('every_year', 1, !(empty($duplicate_product)) ? $duplicate_product->every_year : false, ['class' => 'input-icheck', 'id'=>'every_year']); !!} <strong>Every Year*</strong>
                                    </label>
                                </div>
                            </div>
                            <div class="col-sm-6" id="select-year-div">
                                <div class="form-group">
                                    <label>
                                        {!! Form::checkbox('select_year', 1, !(empty($duplicate_product)) ? $duplicate_product->select_year : false, ['class' => 'input-icheck', 'id'=>'select_year']); !!} <strong>Select Year*</strong>
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                {!! Form::select('duration_year', ['1','2','3','4','5'], !empty($duplicate_product->duration) ? $duplicate_product->duration : null, ['class' => 'form-control select2', 'required', 'placeholder' => 'Year']); !!}
                            </div>
                            <div class="col-md-6">
                                {!! Form::select('duration_month', ['1','2','3','4','5','7','8','9','10','11'], !empty($duplicate_product->duration) ? $duplicate_product->duration : null, ['class' => 'form-control select2', 'required', 'placeholder' => 'Month']); !!}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('work_placement', ['Available'=>'Available','Unavailable'=>'Unavailable'], !empty($duplicate_product->work_placement) ? $duplicate_product->work_placement : null, ['placeholder' => __('messages.please_select'), 'id'=>'work_placement', 'class' => 'form-control select2', 'required']); !!}
                    </div>
                </div>
                <div class="col-sm-8 hide" id="work-placement-description-section">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('work_placement_description', !empty(@$duplicate_product->work_placement_description) ? @$duplicate_product->work_placement_description : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('tuition_fee_installment', ['Available'=>'Available','Unavailable'=>'Unavailable'], !empty($duplicate_product->tuition_fee_installment) ? $duplicate_product->tuition_fee_installment : null, ['placeholder' => __('messages.please_select'), 'id'=>'fee_installment', 'class' => 'form-control select2', 'required']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-8 hide" id="fee-installment-description-section">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('fee_installment_description', !empty(@$duplicate_product->fee_installment_description) ? @$duplicate_product->fee_installment_description : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('general_facilities', !empty($duplicate_product->general_facilities) ? $duplicate_product->general_facilities : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                ...
                <div class="row requirements-section">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            {!! Form::select('requirements', ['English Language'=>'English Language','Education'=>'Education','General Requirements'=>'General Requirements'], null, ['placeholder' => __('messages.please_select'),'class' => 'form-control requirement-select']); !!}
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="form-group">
                            {!! Form::label('requirement_details', __('product.requirement_details') . ':') !!}
                            {!! Form::textarea('requirement_details', !empty($duplicate_product->requirement_details) ? $duplicate_product->requirement_details : null, ['class' => 'form-control requirement_details', 'id'=>'requirement_details']); !!}
            ...
            <!-- include module fields -->
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::file('image[]', ['id' => 'upload_image', 'accept' => 'image/*',
                            'required' => $is_image_required, 'class' => 'upload-element','multiple']); !!}
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::file('thumbnail', ['id' => 'thumbnail_image', 'accept' => 'image/*',
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::file('product_brochure', ['id' => 'brochure_image', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
                        <small>
                            <p class="help-block">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('service_features', !empty($duplicate_product->service_features) ? $duplicate_product->service_features : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::label('experiences', __('product.experiences') . ':') !!}
                        {!! Form::textarea('experiences', !empty($duplicate_product->experiences) ? $duplicate_product->experiences : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="form-group">
                        {!! Form::label('specializations', __('product.specializations') . ':') !!}
                        {!! Form::textarea('specializations', !empty($duplicate_product->specializations) ? $duplicate_product->specializations : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                {{-- @if(!empty($common_settings['enable_product_warranty']))
                 <div class="col-sm-6">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>
                            {!! Form::checkbox('disable_reselling', 1, !(empty($duplicate_product)) ? $duplicate_product->disable_reselling : false, ['class' => 'input-icheck']); !!} <strong>@lang('product.disable_reselling')</strong>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('price_changeable',['Yes','No'], !empty($duplicate_product->price_changeable) ? $duplicate_product->price_changeable : null, ['class' => 'form-control', 'required',
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('reselling_price', ['Percentage'=>'Percentage','Fixed'=>'Fixed'], null, ['class' => 'form-control select2','required', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4" id="resellingCommissionAmountFixedSection">
                    <div class="form-group">
                        ...
                        {!! Form::text('reselling_commission_amount', !empty($duplicate_product->reselling_commission_amount) ? $duplicate_product->reselling_commission_amount : null, ['class' => 'form-control', 'required', 'placeholder' => __('product.reselling_commission_amount'), 'id' => 'resellingCommissionAmountFixed']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4 hide" id="resellingCommissionAmountPercentageSection">
                    <div class="form-group">
                        ...
                        {!! Form::select('reselling_commission_amount', range(0, 100), !empty($duplicate_product->reselling_commission_amount) ? $duplicate_product->reselling_commission_amount : null, ['class' => 'form-control', 'required', 'placeholder' => __('product.reselling_commission_amount'), 'id' => 'resellingCommissionAmountPercentage']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::number('extra_commission', !empty($duplicate_product->extra_commission) ? $duplicate_product->extra_commission : null, ['class' => 'form-control', 'required',
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('delivery_mode', ['Online','Offline','Online & Offline'], null, ['class' => 'form-control select2', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        {!! Form::label('delivery_area', __('product.delivery_area') . ':*') !!}
                        {!! Form::select('delivery_area', ['National'=>'National','International'=>'International'], null, ['class' => 'form-control select2', 'id'=>'delivery_area', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                <div class="col-sm-4 hide" id="delivery_cities_section">
                    <div class="form-group">
                        {!! Form::label('delivery_cities', __('product.delivery_cities') . ':*') !!}
                        {!! Form::select('delivery_cities', ['All Cities'=>'All Cities','London'=>'London'], null, ['class' => 'form-control', 'id'=>'delivery_cities', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4 hide" id="delivery_countries_section">
                    <div class="form-group">
                        ...
                        {!! Form::select('delivery_countries', ['All Countries'=>'All Countries','UK'=>'UK'], null, ['class' => 'form-control', 'id'=>'delivery_countries', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                <div class="clearfix"></div>
                ...
                <div class="col-sm-4 hide" id="delivery_cities_excluded_section">
                    <div class="form-group">
                        ...
                        {!! Form::select('delivery_excluded_cities', ['London'=>'London','Manchester'=>'Manchester'], !empty($product->reselling_commission_amount) ? $product->reselling_commission_amount : null, ['class' => 'form-control', 'id'=>'delivery_excluded_cities', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4 hide" id="delivery_countries_excluded_section">
                    <div class="form-group">
                        ...
                        {!! Form::select('delivery_excluded_countries', ['UK'=>'UK','Bangladesh'=>'Bangladesh'], !empty($product->reselling_commission_amount) ? $product->reselling_commission_amount : null, ['class' => 'form-control', 'id'=>'delivery_excluded_countries', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4 hide" id="delivery_countries_excluded_cities_section">
                    <div class="form-group">
                        ...
                        {!! Form::select('delivery_countries_excluded_cities', ['London'=>'London','Dhaka'=>'Dhaka'], !empty($product->reselling_commission_amount) ? $product->reselling_commission_amount : null, ['class' => 'form-control', 'id'=>'delivery_countries_excluded_cities', 'placeholder' => __('messages.please_select')]); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4 hide" id="delivery_area_national_section">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="delivery_area_wise[]" multiple id="deliveryAreaWiseNational">
                ...
                <div class="col-sm-4 hide" id="delivery_area_international_section">
                    <div class="form-group">
                        {!! Form::label('delivery_area', __('product.area_specification') . ':*') !!}
                        <select class="form-control select2" name="delivery_area_wise[]" multiple id="deliveryAreaWiseInternational">
                            <option disabled selected value="">Please Select</option>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        {!! Form::textarea('policy', !empty($duplicate_product->policy) ? $duplicate_product->policy : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>
                            {!! Form::checkbox('unipuller_data_policy', 1, !(empty($duplicate_product)) ? $duplicate_product->unipuller_data_policy : false, ['class' => 'input-icheck', 'required']); !!} <strong>@lang('product.unipuller_data_policy')*</strong>
