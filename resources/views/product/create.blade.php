            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('class', ['Product','Service'], !empty($duplicate_product->class) ? $duplicate_product->class : null, ['placeholder' => __('messages.please_select'), 'class' => 'form-control select2', 'required']); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('study_time', ['Part Time','Full Time'], !empty($duplicate_product->name) ? $duplicate_product->name : null, ['class' => 'form-control select2', 'required']); !!}
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        {!! Form::select('requirements',['English Language'=>'English Language','Education'=>'Education','General Requirements'=>'General Requirements'], !empty($duplicate_product->requirements) ? $duplicate_product->requirements : null, ['class' => 'form-control']); !!}
                    </div>
                </div>
                <div class="col-sm-8">
                    <div class="form-group">
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    {!! Form::text('reselling_commission', !empty($duplicate_product->reselling_commission) ? $duplicate_product->reselling_commission : null, ['class' => 'form-control', 'required',
                ...
                <div class="col-sm-4">
                    ...
                    {!! Form::text('reselling_commission_tuition', !empty($duplicate_product->reselling_commission_tuition) ? $duplicate_product->reselling_commission_tuition : null, ['class' => 'form-control', 'required',
