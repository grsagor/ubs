<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title">Edit Shop Location</h4>
        </div>
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="form-label">Invoice Layout For POS <span class="text-danger">*</span></label>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="form-label">Invoice Layout For Sale <span class="text-danger">*</span></label>
