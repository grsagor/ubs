<div class="col-12 col-xl-9 col-lg-9 col-md-12 col-sm-12" style="">
        ...
        <div class="row mb-4 g-3 product-style-1 shop-list product-list  e-title-hover-primary e-hover-image-zoom"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="page-center">
                                <h4 class="text-center text-danger">{{ 'No Jobs Found.' }}</h4>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Advertise your jobs</h5>
                        <p class="card-text">List your jobs unlimited and completely free.</p>
                ...
                <div class="card">
                    <img src="https://dynamic.placementindia.com/blog_images/20220625113020_image1.jpg"
                        class="card-img-top" alt="Card image">
                    <div class="card-body">
                        <h5 class="card-title">Can't find your jobs?</h5>
                        <p class="card-text">Contact us to get what you need. We will connect
                            you with the right jobs provider who knows that solution.</p>
                        <a href="#" class="button-31">Add</a>
                    </div>
                </div>
                <br>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="#" class="button-31">Details</a>
                    </div>
                </div>
                <br>
            </div>
