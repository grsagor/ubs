...
@section('content')
    ...
    <div class="container">
        ...
        <h4 class="footer-details-title mt-4"><u>Sell on unipuller technology</u></h4>
        ...
        {{-- <div class="header mv">
            ...
            <div class="welcome">
                <h5 class="fw-bold">
                    Unipuller: Where Your Business Partnerships Thrive and Growth Knows No Limits
                </h5>
                <p>
            ...
            <div class="welcome">
                <h5 class="fw-bold">
                    2. Get Started with Unipuller Today!
                </h5>
