...
<option value="Citizen of Antigua and Barbuda">Antigua and Barbuda</option>
...
<option value="Citizen of Bosnia and Herzegovina">Bosnia and Herzegovina</option>
...
<option value="Citizen of Guinea-Bissau">Guinea-Bissau</option>
...
<option value="Citizen of Kiribati">Kiribati</option>
...
<option value="Senegalese">Senegalese</option>
<option value="Serbian">Serbian</option>
<option value="Citizen of Seychelles">Seychelles</option>
<option value="Sierra Leonean">Sierra Leonean</option>
<option value="Singaporean">Singaporean</option>
<option value="Slovak">Slovak</option>
<option value="Slovenian">Slovenian</option>
...
<option value="Citizen of Vanuatu">Vanuatu</option>
<option value="Venezuelan">Venezuelan</option>
<option value="Vietnamese">Vietnamese</option>
<option value="Vincentian">Vincentian</option>
<option value="Wallisian">Wallisian</option>
