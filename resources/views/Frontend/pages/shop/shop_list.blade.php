                            ...
                            <div class="col-lg-12 col-md-4 col-sm-6 d-flex align-content-stretch flex-wrap">
                                <div class="advertise-banner">
                                    ...
                                    <div class="d-flex mt-3 justify-content-between">
                                        <a href="#" target="_blank"><a class="btn btn-dark mr-2">Get Started</a></a>
                                                ...
                                                <div class=" row m-0">
                                                    ...
                                                    <div class=" col-lg-8 col-md-8 col-sm-12 p-0">
                                                        <div class="p-4">
                                                            ...
                                                            <hr class="mt-0">
                                                            <p class="category_text text-dark"> {{ $vendor->subcategory }}</p>
                                                            <p class="about_line  text-dark"> {{ $vendor->about_info }}</p>
                                                        </div>
