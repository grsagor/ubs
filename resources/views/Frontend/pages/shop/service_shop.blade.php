...
<div class="custom_small_screen row shadow m-0 p-0">
    ...
    <img class="top-left-image" src="{{ $vendor->logo ? asset('assets/images/users/' . $vendor->logo) : asset('assets/common_img/vendor_profile.jpeg') }}" />
...
<div class=" mb-5">
    <div class="d-flex align-items-start custom-shop-tab">
        <div class="nav flex-column nav-pills w-25 p-3 me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            <div class="mobileTabManu"><button class="nav-link vendor_sidebar rounded active" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="false">Products & Services</button>
            ...
            <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                <ul role="tablist" aria-owns="nav-tab1 nav-tab2 nav-tab3 nav-tab4" class="nav nav-tabs mt-3 mb-2 product-service-tab" id="nav-tab-with-nested-tabs">
                    <li class="nav-item product_service_tabs" role="presentation">
                        <a class="nav-link active nav-link-style" aria-current="page" id="nav-tab1" href="#tab1-content" data-bs-toggle="tab" data-bs-target="#tab1-content" role="tab" aria-controls="tab1-content" aria-selected="false">Service</a>
                    </li>
                    <li class="nav-item product_service_tabs" role="presentation">
