                            ...
                            <div class="card-body p-0">
                                <div class="row">
                                    <div
                                        ...
                                        <img src="{{ asset('assets/front/images/oa.png') }}" class="img-fluid"
                                            alt="" srcset="">
                                    </div>
                                    <div class="col-lg-7 col-md-8 col-sm-12 p-3">
                                        ...
                                        <hr class="mt-0">
                                        <p class="card-text mb-0">We are committed to creating an actionable strategy,
                                            online marketing & technology
                                            solution for our
                                            partners. As a multidisciplinary company, we operate as a unified,
                                            design-led team. We’re passionate
                                            about what we do, and are driven by a desire to solve challenging problems
                                            on behalf of our
                                            partners.</p>
                                        <ul class="list-group">
