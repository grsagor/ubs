                ...
                <form id="registerform" action="#" method="POST">
                    ...
                    <div class="step" id="step1">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control select-style" placeholder="Email"
                                autocomplete="off">
                        </div>

                        <div class="form-group">
                            <label for="mobile">Mobile</label>
                            <input type="text" name="name" class="form-control select-style" placeholder="Mobile">
                        </div>
