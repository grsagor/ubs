                            ...
                            <div id="sidebar" class="widget-title-bordered-full">
                                ...
                                <div id="woocommerce_product_categories-4"
                                    ...
                                    <ul class="product-categories">
                                        ...
                                        <li class="cat-item cat-parent">
                                            <a href="#" class="category-link" id="cat">Property Wanted <span
                                                    class="count"></span></a>
                                        </li>

                                        <li class="cat-item cat-parent">
                                            <a href="#" class="category-link" id="cat">Education <span
                                                    class="count"></span></a>
                                        </li>
                            ...
                            <div class="product-search-one">
                                <form id="searchForm" class="search-form form-inline search-pill-shape bg-white"
                                    ...
                                    <input type="text" id="shop_name" class="col form-control search-field"
                                        name="search" placeholder="Search title or property type or property address"
                                                ...
                                                <div class="product type-product rounded ">
                                                    ...
                                                    <div class=" row m-0">
                                                        ...
                                                        <div class=" col-lg-8 col-md-8 col-sm-12 p-0">
                                                            ...
                                                            <div class="p-2">
                                                                <h5 class="product-title large_screen mb-1">
                                                                    <a class="text-dark"
