        ...
        <div class="full-row bg-light overlay-dark py-5"
            ...
            <div class="container">
                <div class="row text-center text-white">
                                            ...
                                            <div class="row mobile-reverse">
                                                            ...
                                                            <ul class="product-categories">
                                                                ...
                                                                <li class="cat-item cat-parent">
                                                                    <a href="{{ route('property.list') }}"
                                                                        class="category-link" id="cat">Properties
                                                ...
                                                <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12">
                                                    <div class="product-search-one">
                                                        <form id="searchForm"
                                                            class="search-form form-inline search-pill-shape bg-white"
                                        ...
                                        <select name="country" class="form-control categoris mx-2" id="country_select">
                                            ...
                                            @endforeach
                                                            ...
                                                            <input type="text" id="shop_name"
                                                                class="col form-control search-field" name="search"
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="product type-product rounded ">
                                                                            ...
                                                                            <div class=" row m-0">
                                                                                ...
                                                                                <div
                                                                                    class=" col-lg-8 col-md-8 col-sm-12 p-0">
                                                                                    ...
                                                                                    <div class="d-flex text-center"
                                                                                        ...
                                                                                        <span
                                                                                            class=" flex-fill mb-0 text-white">
                                                                                            <p
                                                                                                class="lower-section-text mb-0  text-muted">
                                                                                                Available
                                                                                            </p>
                                                                                            <p class="mb-0 text-muted">
                                                                                                {{ $item->available_form }}
                                                            ...
                                                            <div class="card">
                                                                <div class="card-body">
                                                                    <div class="page-center">
                                                                        <h4 class="text-center">{{ 'No Room Found.' }}
                                                                        </h4>
                                                                    </div>
                                                                </div>
                                                            </div>
                    ...
                    @endforeach
                @endsection
                >>>>>>> c58789c6ebaa68e82ca6e087a56fc8cc6ba16b89
