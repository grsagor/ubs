...
<body class="font-Noto-Sans">
    ...
    <!-- Header -->
    <header class="w-full bg-[url({{ asset('error/comming_soon.jpg') }})] bg-cover bg-bottom">
        <div class="w-full min-h-screen md:w-1/2 bg-gradient-to-b from-gray-900/90 to-gray-900/95 p-10 flex">
            <div class="w-full text-center my-auto">
                ...
                <!-- Content -->
                {{-- <p class="text-base mb-10 text-gray-200 md:text-right">Lorem ipsum dolor sit amet consectetur
    ...
    <script>
        ...
        var countDownEndDate = "November 5, 2023 09:00:00";
