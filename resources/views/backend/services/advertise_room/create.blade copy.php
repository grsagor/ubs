                                    ...
                                    <fieldset>
                                        ...
                                        <fieldset class="form_room_fieldset" id="room2" style="display: none;">
                                            ...
                                            <div class="form_row form_row_cost ">
                                                ...
                                                <div class="form_inputs">
                                                    <span class="form_input form_text">
                                                        <span class="form_currency_symbol">£</span>
                                                        <input type="number" name="room_cost_of_amount2"
                                                            value="" size="6" step="any">
                                                    </span>
                                                    <label class="form_input form_radio">
                                            ...
                                            <div class="form_row form_row_deposit ">
                                                ...
                                                <div class="form_inputs">
                                                    <span class="form_input form_text">
                                                        <span class="form_currency_symbol">£</span> <input
                                                            type="number" name="room_security_deposit2"
                                                            value="" step="any" min="0">
                                                        {{-- <a class="offered-ad__deposit-limit-link">Check deposit limits</a> --}}
                                                    </span>
                                                </div>
                                        ...
                                        <fieldset class="form_room_fieldset" id="room3" style="display: none;">
                                            ...
                                            <div class="form_row form_row_deposit ">
                                                ...
                                                <div class="form_inputs">
                                                    <span class="form_input form_text">
                                                        <span class="form_currency_symbol">£</span> <input
                                                            type="number" name="room_security_deposit3"
                                                            value="" step="any" min="0">
                                                        {{-- <a class="offered-ad__deposit-limit-link">Check deposit limits</a> --}}
                                                    </span>
                                                </div>
                                        ...
                                        <div class="form_row form_row_ref_req">
                                            ...
                                            <div class="form_inputs">
                                                ...
                                                <label class="form_input form_radio">
                                                    <input type="radio" name="room_reference" checked=""
                                                        value=2>
                                                    no
                                                </label>
                                            </div>
                                ...
                                <li class="msg-warning__list-item"><i class="far fa-check"></i>
                                    <p class="msg-warning__text">Familiarise yourself with <a
                                                    ...
                                                    <div data-testid="uploader">
                                                        <div class="dropzone-wrapper">
                                                            <div class="dropzone-button">
                                                                ...
                                                                <input type="file" name="advert_photos[]"
                                                                    multiple />
                                        ...
                                        <div class="form_row form_row_tel">
                                            ...
                                            <div class="form_inputs">
                                                <span class="form_input form_text">
                                                    <input class="form_input_tel" type="tel"
                                                        name="advert_telephone" value="+1 (655) 337-3249"
                                                        autocomplete="tel" id="form_input--tel-n">
                                                </span>
                                                <label class="form_input form_checkbox">
