                             ...
                             <div class="form-group">
                                 ...
                                 <select class="form-control" name="business_location_id">
                                     ...
                                     @foreach ($business_locations as $item)
                                         <option {{ $property->business_location_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                     @endforeach
                                 </select>
                             </div>
                         </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <select class="form-control" id="child_category_id" name="child_category_id">
                                     ...
                                     @foreach ($child_categories as $item)
                                         <option {{ $property->child_category_id == $item->id ? 'selected' : '' }} value="{{ $item->id }}">{{ $item->name }}</option>
                                     @endforeach
                                 </select>
                             </div>
                         </div>
                             ...
                             <div class="form-group">
                                 ...
                                 <select class="form-control" id="property_room_quantity" name="property_room_quantity">
                                     ...
                                     @foreach (['1 Room for Rent', '2 Rooms for Rent', '3 Rooms for Rent', '4 Rooms for Rent', '5 Rooms for Rent'] as $key => $item)
                                         <option {{ $property->property_room_quantity == $key + 1 ? 'selected' : '' }} value="{{ $key + 1 }}">{{ $item }}
                                         </option>
                                     @endforeach
                                 </select>
                             </div>
