                    ...
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'property_to_rent.view',
                                    in_array('property_to_rent.view', $role_permissions),
                                    [
                                        'class' => 'input-icheck',
                                    ],
                                ) !!} {{ __('role.property_to_rent.view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'property_to_rent.create',
                                    in_array('property_to_rent.create', $role_permissions),
                                    [
                                        'class' => 'input-icheck',
                                    ],
                                ) !!} {{ __('role.property_to_rent.create') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'property_to_rent.update',
                                    in_array('property_to_rent.update', $role_permissions),
                                    [
                                        'class' => 'input-icheck',
                                    ],
                                ) !!} {{ __('role.property_to_rent.update') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox(
                                    'permissions[]',
                                    'property_to_rent.delete',
                                    in_array('property_to_rent.delete', $role_permissions),
                                    [
                                        'class' => 'input-icheck',
                                    ],
                                ) !!} {{ __('role.property_to_rent.delete') }}
                            </label>
                        </div>
                    </div>
                </div>
