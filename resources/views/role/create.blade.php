            ...
            <div class="row check_group">
                ...
                <div class="col-md-9">
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'property_to_rent.view', false, ['class' => 'input-icheck']) !!} {{ __('role.property_to_rent.view') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'property_to_rent.create', false, ['class' => 'input-icheck']) !!} {{ __('role.property_to_rent.create') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'property_to_rent.update', false, ['class' => 'input-icheck']) !!} {{ __('role.property_to_rent.update') }}
                            </label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('permissions[]', 'property_to_rent.delete', false, ['class' => 'input-icheck']) !!} {{ __('role.property_to_rent.delete') }}
                            </label>
                        </div>
                    </div>
                </div>
