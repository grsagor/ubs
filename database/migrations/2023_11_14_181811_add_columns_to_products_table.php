...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('products', function (Blueprint $table) {
            ...
            $table->integer('duration')->nullable()->after('sub_category_id');
            ...
            $table->string('reselling_commission')->nullable()->after('sub_category_id');
            $table->string('reselling_commission_tuition')->nullable()->after('sub_category_id');
