$(document).ready(function () {
  ...
  $(
    "select#product_category, select#product_brand, select#product_type, select#select_location_id"
...
$("div#product_list_body").on("scroll", function () {
  if ($(this).scrollTop() + $(this).innerHeight() >= $(this)[0].scrollHeight) {
    ...
    var type_id = $("select#product_type").val();
