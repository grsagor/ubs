...
$(document).ready(function () {
  ...
  jQuery.validator.addMethod(
    ...
    function (value, element, param) {
      ...
      return (
        is_draft || this.optional(element) || !(param < __number_uf(value))
      );
    },
  ...
  jQuery.validator.addMethod("abs_digit", function (value, element) {
    return (
      this.optional(element) || Number.isInteger(Math.abs(__number_uf(value)))
    );
  });
  ...
  var pdf_btn = {
    extend: "pdf",
    text:
      '<i class="fa fa-file-pdf" aria-hidden="true"></i> ' + LANG.export_to_pdf,
    className: "btn-sm",
    exportOptions: {
      columns: ":visible",
    },
...
$(document).on(
  "mouseleave",
  "button#btnCalculator, button#return_sale",
  function (e) {
    $(this).tooltip("hide");
  }
);
