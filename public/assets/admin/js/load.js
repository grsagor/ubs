(function($) {
  ...
  //]]>
        ...
        $("#national_int").on( "change", function() {
          $(this).parent().parent().next().removeClass('showbox');
          if(this.value == 1){
            $(this).parent().parent().next().find('.country-list').addClass('showbox');
            $(this).parent().parent().next().find('.city-list').removeClass('showbox');
          }
          else{
            $(this).parent().parent().next().find('.country-list').removeClass('showbox');
            $(this).parent().parent().next().find('.city-list').addClass('showbox');
          }
          $(".select2").select2();
      });
      // Check Click Ends :)
